...
-- II/ 
--1/ Liệt kê các sản phẩm gồm các thông tin product names và product ID có trên 100 đơn hàng trong tháng 7 năm 2008 
...
--5/ Tìm các mô hình sản phẩm (ProductModelID) mà giá niêm yết (list price) tối đa cao hơn 
--giá trung bình của tất cả các mô hình.
...
--8/ Liệt kê các sản phầm không có đơn đặt hàng nào thông tin gồm ProductID, Name, 
--dùng 3 cách Not in, not exists và left join.
select P.productID, Name
